...
<a
href="https://github.com/cj-mills/cjm-fasthtml-viewport-fit/blob/main/cjm_fasthtml_viewport_fit/models.py#L13"
...
def ViewportFitConfig(
    namespace:str, target_id:str, inner_id:str='', min_height:int=200, debounce_ms:int=100, scroll_to_top:bool=True,
    enable_htmx_settle:bool=True, observe_siblings:bool=True, resize_callback:str='', debug:bool=False
)->None:
